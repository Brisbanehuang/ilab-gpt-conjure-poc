...
try {
  for (const viewport of [{ width: 1440, height: 1000 }, { width: 390, height: 844 }]) {
    ...
    await model.selectOption("gpt-image-2.5-sunburst");
    ...
    console.log(`PASS ${viewport.width}px: model/key selection, history reuse, submit, persistence, i18n, lookup errors, no provider writes`);
    await page.close();
  }
